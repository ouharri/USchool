          ...
          <ul>
            <li class="relative px-6 py-3">
              <a
                ...
                <span class="ml-4 xl:block" :class="IsOpenSemiSide? 'block':'sm:hidden'">Forms</span>
              </a>
            </li>
            <li class="relative px-6 py-3">
              <a
                ...
                <span class="ml-4 xl:block" :class="IsOpenSemiSide? 'block':'sm:hidden'">Cards</span>
              </a>
            </li>
            <li class="relative px-6 py-3">
              <a
                ...
                <span class="ml-4 xl:block" :class="IsOpenSemiSide? 'block':'sm:hidden'">Charts</span>
              </a>
            </li>
            <li class="relative px-6 py-3">
              <a
                ...
                <span class="ml-4 xl:block" :class="IsOpenSemiSide? 'block':'sm:hidden'">Buttons</span>
              </a>
            </li>
            <li class="relative px-6 py-3">
              <a
                ...
                <span class="ml-4 xl:block" :class="IsOpenSemiSide? 'block':'sm:hidden'">Modals</span>
              </a>
            </li>
            <li class="relative px-6 py-3">
              <a
                ...
                <span class="ml-4 xl:block" :class="IsOpenSemiSide? 'block':'sm:hidden'">Tables</span>
              </a>
            </li>
            <li class="relative px-6 py-3">
              <button
              ...
              <span class="inline-flex items-center">
                ...
                <span class="ml-4 xl:block" :class="IsOpenSemiSide? 'block':'sm:hidden'">Pages</span>
              </span>
