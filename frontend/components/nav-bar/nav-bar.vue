      ...
      <div class="flex justify-center flex-1 lg:mr-32 transition duration-700 ease-in-out"
        ...
        <div :class="`focus-within:text-${theme.color.primary}`"
          ...
          <input @focusin="focusSearchInput" @focusout="handleSearchInput"
                 class="w-full md:block pl-10 bg-gray-100 sm:pr-2 py-2.5 text-sm text-gray-700 placeholder-gray-600 z-10 border-0 rounded-full placeholder: peer-placeholder-shown:-translate-y-1/2 dark:placeholder-gray-500 dark:focus:shadow-outline-gray dark:focus:placeholder-gray-600 dark:bg-gray-700 dark:text-gray-200 focus:placeholder-gray-500 form-input transition duration-700 ease-in-out"
